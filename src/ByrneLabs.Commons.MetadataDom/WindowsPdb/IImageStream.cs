...
{
    /// <summary>Interface to access part of some data</summary>
    public interface IImageStream : IBinaryReader
    {
        /// <summary>Returns the file offset of the stream</summary>
        FileOffset FileOffset { get; }

        /// <summary>Creates a sub stream that can access parts of this stream</summary>
    ...
    {
        /// <summary>Clones this <see cref="IImageStream" />
        /// </summary>
