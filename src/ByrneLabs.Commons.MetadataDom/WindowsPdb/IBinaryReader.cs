...
namespace ByrneLabs.Commons.MetadataDom.WindowsPdb
{
    ...
    public interface IBinaryReader : IDisposable
    {
        ...
        /// <summary>Gets/sets the position</summary>
        long Position { get; set; }

        /// <summary>Reads <paramref name="length" /> bytes to <paramref name="buffer" /> and increments
        ///     <see cref="Position" /> by the number of bytes read.</summary>
        /// <param name="buffer">Buffer</param>
        /// <param name="offset">Offset in buffer where to place all read bytes</param>
        /// <param name="length">Number of bytes to read</param>
        /// <returns>Number of bytes read, and can be less than <paramref name="length" /> if there's no more bytes to read.</returns>
        int Read(byte[] buffer, int offset, int length);

        /// <summary>Reads a <see cref="byte" /> from the current position and increments <see cref="Position" /> by 1</summary>
        /// <returns>The 8-bit unsigned byte</returns>
        /// <exception cref="IOException">An I/O error occurs</exception>
        byte ReadByte();

        /// <summary>Reads <paramref name="size" /> bytes from the current <see cref="Position" />
        ///     and increments <see cref="Position" /> by <paramref name="size" /> bytes</summary>
        /// <param name="size">Number of bytes to read</param>
        /// <returns>All available bytes. This can be less than <paramref name="size" /> bytes if there's not enough bytes left.</returns>
        /// <exception cref="IOException">An I/O error occurs</exception>
        byte[] ReadBytes(int size);

        /// <summary>Reads bytes until byte <paramref name="b" /> is found. <see cref="Position" /> is incremented by the number of bytes read (size of return value).</summary>
        ...
        /// <summary>Reads a <see cref="Double" /> from the current position and increments <see cref="Position" /> by 8</summary>
        /// <returns>The 64-bit double</returns>
        /// <exception cref="IOException">An I/O error occurs</exception>
        double ReadDouble();

        /// <summary>Reads a <see cref="Int16" /> from the current position and increments <see cref="Position" /> by 2</summary>
        /// <returns>The 16-bit signed integer</returns>
        /// <exception cref="IOException">An I/O error occurs</exception>
        short ReadInt16();

        /// <summary>Reads a <see cref="Int32" /> from the current position and increments <see cref="Position" /> by 4</summary>
        /// <returns>The 32-bit signed integer</returns>
        /// <exception cref="IOException">An I/O error occurs</exception>
        int ReadInt32();

        /// <summary>Reads a <see cref="Int64" /> from the current position and increments <see cref="Position" /> by 8</summary>
        /// <returns>The 64-bit signed integer</returns>
        /// <exception cref="IOException">An I/O error occurs</exception>
        long ReadInt64();

        /// <summary>Reads a <see cref="sbyte" /> from the current position and increments <see cref="Position" /> by 1</summary>
        /// <returns>The 8-bit signed byte</returns>
        /// <exception cref="IOException">An I/O error occurs</exception>
        sbyte ReadSByte();

        /// <summary>Reads a <see cref="Single" /> from the current position and increments <see cref="Position" /> by 4</summary>
        /// <returns>The 32-bit single</returns>
        /// <exception cref="IOException">An I/O error occurs</exception>
        float ReadSingle();

        /// <summary>Reads a <see cref="String" /> from the current position and increments <see cref="Position" />
        ///     by the number of bytes read.</summary>
        /// <param name="chars">Number of characters to read</param>
        /// <returns>The string</returns>
        /// <exception cref="IOException">An I/O error occurs</exception>
        string ReadString(int chars);

        /// <summary>Reads a <see cref="UInt16" /> from the current position and increments <see cref="Position" /> by 2</summary>
        /// <returns>The 16-bit unsigned integer</returns>
        /// <exception cref="IOException">An I/O error occurs</exception>
        ushort ReadUInt16();

        /// <summary>Reads a <see cref="UInt32" /> from the current position and increments <see cref="Position" /> by 4</summary>
        /// <returns>The 32-bit unsigned integer</returns>
        /// <exception cref="IOException">An I/O error occurs</exception>
        uint ReadUInt32();

        /// <summary>Reads a <see cref="UInt64" /> from the current position and increments <see cref="Position" /> by 8</summary>
    ...
    {
        /// <summary>Checks whether we can read <paramref name="size" /> bytes</summary>
        ...
        /// <summary>Creates a <see cref="Stream" /> using <paramref name="reader" />. The created
        ///     <see cref="Stream" /> doesn't own <paramref name="reader" />, so it's not
        ///     <see cref="IDisposable.Dispose()" />'d.</summary>
        ...
        /// <summary>Creates a <see cref="Stream" /> using <paramref name="reader" />
        /// </summary>
        /// <param name="reader">this</param>
        ...
        /// <summary>Reads a 7-bit encoded integer</summary>
        /// <param name="reader">this</param>
        ...
        /// <summary>Reads a <see cref="Boolean" /> from the current position and increments <see cref="IBinaryReader.Position" /> by 1</summary>
        /// <param name="self">this</param>
        /// <returns>The boolean</returns>
        /// <exception cref="IOException">An I/O error occurs</exception>
        public static bool ReadBoolean(this IBinaryReader self) => self.ReadByte() != 0;

        /// <summary>Reads a <see cref="Boolean" /> at offset <paramref name="offset" />
        /// </summary>
        /// <param name="reader">this</param>
        ...
        /// <summary>Reads a <see cref="Byte" /> at offset <paramref name="offset" />
        /// </summary>
        /// <param name="reader">this</param>
        /// <param name="offset">Offset</param>
        ...
        /// <summary>Reads a <see cref="Char" /> from the current position and increments <see cref="IBinaryReader.Position" /> by 2</summary>
        /// <param name="self">this</param>
        ...
        public static char ReadChar(this IBinaryReader self, Encoding encoding)
        {
            ...
            var twoBytes = encoding is UnicodeEncoding;
            ...
            while (true)
            {
                ...
                var x = decoder.GetChars(bytes, 0, twoBytes ? 2 : 1, chars, 0);
                if (x != 0)
                {
                    break;
                }
        ...
        /// <summary>Reads a <see cref="Char" /> at offset <paramref name="offset" />
        /// </summary>
        /// <param name="reader">this</param>
        /// <param name="offset">Offset</param>
        ...
        /// <summary>Reads a compressed <see cref="int" /> from the current position in <paramref name="reader" />
        /// </summary>
        ...
        public static bool ReadCompressedInt32(this IBinaryReader reader, out int val)
        {
            ...
            if ((b & 0xC0) == 0x80)
            {
                ...
                var tmp = (uint) ((b & 0x3F) << 8 | reader.ReadByte());
                if ((tmp & 1) != 0)
                {
            ...
            if ((b & 0xE0) == 0xC0)
            {
                ...
                var tmp = (uint) ((b & 0x1F) << 24 | reader.ReadByte() << 16 |
        ...
        /// <summary>Reads a compressed <see cref="uint" /> from the current position in <paramref name="reader" />
        /// </summary>
        ...
        /// <summary>Reads a <see cref="Decimal" /> from the current position and increments
        ///     <see cref="IBinaryReader.Position" /> by 16</summary>
        /// <param name="reader">this</param>
        ...
        /// <summary>Reads a <see cref="Decimal" /> at offset <paramref name="offset" />
        /// </summary>
        /// <param name="reader">this</param>
        /// <param name="offset">Offset</param>
        ...
        /// <summary>Reads a <see cref="Double" /> at offset <paramref name="offset" />
        /// </summary>
        /// <param name="reader">this</param>
        /// <param name="offset">Offset</param>
        ...
        /// <summary>Reads a <see cref="Int16" /> at offset <paramref name="offset" />
        /// </summary>
        /// <param name="reader">this</param>
        /// <param name="offset">Offset</param>
        ...
        /// <summary>Reads a <see cref="Int32" /> at offset <paramref name="offset" />
        /// </summary>
        /// <param name="reader">this</param>
        /// <param name="offset">Offset</param>
        ...
        /// <summary>Reads a <see cref="Int64" /> at offset <paramref name="offset" />
        /// </summary>
        /// <param name="reader">this</param>
        /// <param name="offset">Offset</param>
        ...
        /// <summary>Reads a <see cref="SByte" /> at offset <paramref name="offset" />
        /// </summary>
        /// <param name="reader">this</param>
        /// <param name="offset">Offset</param>
        ...
        /// <summary>Reads a <see cref="Single" /> at offset <paramref name="offset" />
        /// </summary>
        /// <param name="reader">this</param>
        /// <param name="offset">Offset</param>
        ...
        /// <summary>Reads a UTF-8 <see cref="string" /> from the current position and increments
        ///     <see cref="IBinaryReader.Position" /> by the length of the string.</summary>
        /// <param name="reader">this</param>
        /// <returns>The string</returns>
        public static string ReadString(this IBinaryReader reader) => reader.ReadString(Encoding.UTF8);

        /// <summary>Reads a <see cref="string" /> from the current position and increments
        ///     <see cref="IBinaryReader.Position" /> by the length of the string.</summary>
        /// <param name="reader">this</param>
        /// <param name="encoding">Encoding</param>
        /// <returns>The string</returns>
        ...
        /// <summary>Reads a <see cref="UInt16" /> at offset <paramref name="offset" />
        /// </summary>
        /// <param name="reader">this</param>
        /// <param name="offset">Offset</param>
        ...
        /// <summary>Reads a <see cref="UInt32" /> at offset <paramref name="offset" />
        /// </summary>
        /// <param name="reader">this</param>
        /// <param name="offset">Offset</param>
        ...
        /// <summary>Reads a <see cref="UInt64" /> at offset <paramref name="offset" />
        /// </summary>
        /// <param name="reader">this</param>
        /// <param name="offset">Offset</param>
        ...
        /// <summary>Writes <paramref name="reader" />, starting at <paramref name="reader" />'s current position, to <paramref name="writer" /> starting at
        ///     <paramref name="writer" />'s current position. Returns the number of bytes written.</summary>
        /// <param name="reader">Reader</param>
        ...
        public static uint WriteTo(this IBinaryReader reader, BinaryWriter writer, byte[] dataBuffer)
        {
            ...
            var longLenLeft = reader.Length - reader.Position;
            if (longLenLeft > uint.MaxValue)
            {
                throw new IOException("Data is too big");
            }

            var lenLeft = (uint) longLenLeft;
            var writtenBytes = lenLeft;
            while (lenLeft > 0)
            {
                var num = (int) Math.Min((uint) dataBuffer.Length, lenLeft);
                lenLeft -= (uint) num;
