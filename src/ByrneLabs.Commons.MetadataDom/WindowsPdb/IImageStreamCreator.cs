...
{
    /// <summary>Creates a new stream that accesses part of some data</summary>
    public interface IImageStreamCreator : IDisposable
    {
        /// <summary>The file name or <c>null</c> if data is not from a file</summary>
        string FileName { get; }

        /// <summary>Returns the total length of the original data</summary>
        long Length { get; }

        /// <summary>Creates a stream that can access only part of the data</summary>
        ...
        /// <summary>Creates a stream that can access all data</summary>
        /// <returns>A new stream</returns>
    ...
    {
        /// <summary>Creates a stream that can access all data starting from <paramref name="offset" />
        /// </summary>
