...
namespace ByrneLabs.Commons.MetadataDom.Tests.Checker
{
    public static class SignatureCreater
    {
        ...
        public static string GetTextSignature(TypeInfo typeInfo, bool includeGenericArguments = false)
        {
            string parent;
            string name;
            ...
            {
                parent = GetTextSignature(typeInfo.DeclaringType.GetTypeInfo(), includeGenericArguments) + "+";
                name = typeInfo.Name;
            }
